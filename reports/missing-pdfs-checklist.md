# Missing PDFs Checklist

46 cited papers without PDFs in `Literature/Papers/`. Organized by chapter.

---

## Appendix A — Computational Modeling (~22 papers)

Classic FDTD/CEM references, mostly from the Taflove/Smith era:

- [x] **Yee66** — K. S. Yee, "Numerical Solution of Initial Boundary Value Problems…" *(also Ch 1)* → `Yee1966_FDTD_Maxwells_Equations.pdf`
- [ ] **Taf2005** — A. Taflove & S. C. Hagness, *Computational Electrodynamics* (textbook) — not on IEEE
- [x] **Gedney96** — S. Gedney, "An Anisotropic PML Absorbing Medium…" → `Gedney1996_Anisotropic_PML.pdf`
- [ ] **Gedney05** — S. Gedney, Lansing, Chavannes, "Nonuniform Grids, Nonorthogonal Grids…" — book chapter, not on IEEE
- [ ] **Gedney2005** — S. Gedney, "Perfectly Matched Layer ABCs" — book chapter, not on IEEE
- [ ] **Gedney2011** — S. D. Gedney, *Intro to FDTD Method* (textbook) — not on IEEE
...
- [x] **LeeHornTEM** — R. T. Lee & G. S. Smith, "Design Study for the Basic TEM Horn Antenna" → `LeeSmith2004_TEM_Horn_Design.pdf`
- [x] **Dyson65** — J. D. Dyson, "Characteristics and Design of the Conical Log-Spiral Antenna" → `Dyson1965_Conical_LogSpiral.pdf`
- [ ] **Shlager94** — K. L. Shlager & G. S. Smith, "Near-Field to Near-Field Transformation" — not found on IEEE
- [ ] **Shlager95** — K. L. Shlager & G. S. Smith, "Comparison of Two NF-to-NF Methods" — not found on IEEE
- [x] **Shlager96** — K. L. Shlager, G. S. Smith, J. G. Maloney, "Accurate Analysis of…" → `ShlagerSmithMaloney1994_TEM_Horn_FDTD.pdf`
- [x] **ShlagerBowtie94** — K. L. Shlager, G. S. Smith, J. G. Maloney, "Optimization of Bow-Tie…" → `ShlagerSmithMaloney1994_Bowtie_Optimization.pdf`
...
## Ch 2/3 — Original & Improved Approach

- [ ] **BalanisHB** — G. S. Smith & J. G. Maloney, "FDTD Method Applied to Antennas" (Balanis Handbook chapter)
- [ ] **BalanisHB12** — W. Croswell et al., Balanis Handbook Ch 12 *(also Ch 6)*
- [x] **Herscovici** — N. Herscovici et al. (pixelated antenna work) *(Ch 2, Ch 3)* → `Herscovici2008_Fragmented_ApertureCoupled.pdf`
- [x] **EllgardtPersson** — A. Ellgardt & P. Persson, wide-scan fragmented array *(Ch 3)* → `EllgardtPersson2006_WideScan_Fragmented.pdf`

---

## Ch 4 — Advanced Fragmented

- [x] **HerscoviciScanning** — N. Herscovici, scanning pixelated antenna → `Herscovici2009_Scanning_Fragmented_Array.pdf`
- [x] **MaloneyBakerGPS** / **Maloney2007Fragmented** — Maloney & Baker, GPS CRPA (same paper) → `Maloney2007_GPS_CRPA_Fragmented.pdf`
- [ ] **ODonnell2009Hybrid** — T. H. O'Donnell et al., "Hybrid Chromosome Design for Genetic Optimization of a Fragmented Patch"

---

## Ch 5 — Reconfigurable

- [ ] **Balanis2007ReconfigChapter** — G. H. Huff & J. T. Bernhard, "Reconfigurable Antennas" (Balanis Handbook chapter)
- [x] **LeeSmith2004** — R. T. Lee & G. S. Smith, "Design Study for the Basic TEM…" → `LeeSmith2004_TEM_Horn_Design.pdf`

---

## Ch 8 — Reconfigurable Arrays

- [ ] **DARPAact2013** — DARPA, "Starting point for phased array ACT program" (program doc)

---

## Ch 9 — Recent Innovations

- [x] **Altshuler1997GAWire** — E. E. Altshuler & D. S. Linden, "Wire-Antenna Designs Using Genetic Algorithms" → `Altshuler1997_GA_Wire_Antenna.pdf`
...
> **Note:** Author's own papers (15 keys: Maloney*, Pringle*, RECAP, FriederichPringle) and textbooks/theses (SmithBook, EllgardtThesis, ReidThesis, IEEEstd) are excluded — no PDFs needed for those.
