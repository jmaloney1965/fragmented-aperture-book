...
The work described in this chapter was motivated in part by the DARPA Arrays at Commercial Timescales (ACT) program, which sought to dramatically reduce the cost and development time of phased array antenna systems by leveraging commercial semiconductor manufacturing processes.  The reconfigurable fragmented aperture array concept was proposed as a solution that could deliver wide-bandwidth, wide-scan-volume performance using a single, mass-producible element design with electronically switchable pixel configurations.

\textcolor{red}{\textbf{[PLACEHOLDER: Additional details of the ACT program context and specific results will be included when the original proposal data is located or the designs are regenerated.]}}
