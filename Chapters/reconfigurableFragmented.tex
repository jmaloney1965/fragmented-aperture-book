...
\includegraphics[angle=0,scale=0.7]{/Users/jim.maloney/Book/images/ch5/RECAP1.png}
...
\begin{figure}\begin{center}
\includegraphics[angle=0,width=0.85\linewidth]{/Users/jim.maloney/Book/images/ch5/maloney2000/Maloney2000_Fig3_TestBed.png}
\caption{Second-generation switched fragmented aperture test bed using magnetically actuated reed switches.  Inset shows an individual switch/magnet assembly.  This test bed permitted rapid evaluation of different switch configurations \cite{Maloney2000Switched}.}
\label{fig:RECAP_EARLY1}
\end{center}\end{figure}

\begin{figure}\begin{center}
\includegraphics[angle=0,width=0.85\linewidth]{/Users/jim.maloney/Book/images/ch5/maloney2000/Maloney2000_Fig5_BroadsideEndfire.png}
\caption{Beam steering demonstration on the second-generation test bed.  Two different switch configurations (left) and their measured radiation patterns (right): broadside (top) and endfire (bottom).  The strikingly different conducting patterns produce fundamentally different radiation characteristics from the same physical aperture \cite{Maloney2000Switched}.}
...
\begin{figure}\begin{center}
\includegraphics[angle=0,scale=0.7]{/Users/jim.maloney/Book/images/ch5/RECAP2.png}
...
\begin{figure}\begin{center}
\includegraphics[angle=0,scale=0.7]{/Users/jim.maloney/Book/images/ch5/RECAP3.png}
...
\begin{figure}\begin{center}
\includegraphics[angle=0,scale=0.7]{/Users/jim.maloney/Book/images/ch5/RECAP4.png}
...
\begin{figure}\begin{center}
\includegraphics[angle=0,scale=0.5]{/Users/jim.maloney/Book/images/ch5/RECAP5.png}
...
\begin{figure}\begin{center}
\includegraphics[angle=0,scale=0.6]{/Users/jim.maloney/Book/images/ch5/RECAP6.png}
...
\begin{figure}\begin{center}
\includegraphics[angle=0,scale=0.6]{/Users/jim.maloney/Book/images/ch5/RECAP7.png}
...
\begin{figure}\begin{center}
\includegraphics[angle=0,width=0.55\linewidth]{/Users/jim.maloney/Book/images/ch5/kiesel2017/Kiesel2017_Fig2_CylindricalAntenna.png}
\caption{The 133-mm diameter cylindrical reconfigurable pixel antenna mounted on a ground plane in the anechoic chamber.  The smart pixel boards wrap around the cylinder, providing 24 independently switchable pixels for full azimuthal beam steering \cite{Kiesel2017Cylindrical}.}
...
\begin{figure}\begin{center}
\includegraphics[angle=0,width=0.85\linewidth]{/Users/jim.maloney/Book/images/ch5/kiesel2017/Kiesel2017_Fig7_HemisphericalCoverage.png}
