...
\textbf{Chapter~10: Fragmented Apertures Applied to Other Electromagnetic Structures.}  The fragmented aperture design methodology is not limited to antennas.  This chapter describes applications of the same pixelated optimization approach to non-antenna electromagnetic structures, including broadband phase surfaces, RF power combining networks, frequency-selective surfaces, and metamaterials.
