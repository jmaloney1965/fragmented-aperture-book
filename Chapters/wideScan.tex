...
We next choose the number of fragments across the unit cell using our traditional rules-of-thumb [4], i.e. typically 20-30 fragments across the unique quadrant of the element as shown in Fig. 4. The element is designed using the genetic algorithm approach described in [4] modified to use the spectral FDTD as discussed above in Section III for the normalized Kz \& Ky values shown in Fig. 5.
