...
\caption{Unbalanced-feed 4$\times$4 prototype array: (a) assembled array with unit cell inset, (b) measured vs.\ simulated broadside realized gain, and (c) normalized gain for varying array sizes compared to infinite array prediction \cite{Landgren2017Unbalanced}.}
\label{fig:WBA23}
\end{center}
\end{figure}
