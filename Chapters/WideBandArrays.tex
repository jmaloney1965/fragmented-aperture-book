...
\begin{figure}
\begin{center}
\includegraphics[angle=0,width=\linewidth]{/Users/jim.maloney/Book/images/ch6/BalanisHandbookFig12-42.png}
\caption[Gain comparison of current sheet, spiral, and bowtie]{Predicted gain for three antenna types occupying a $10'' \times 10''$ aperture: a uniform current sheet (theoretical ideal), a spiral antenna, and a bowtie antenna.  Neither the spiral nor the bowtie approaches the broadband aperture gain limit \cite{BalanisHB12}.}
\label{fig:WBA1}
\end{center}
\end{figure}
...
\begin{figure}
\begin{center}
\includegraphics[angle=0,width=\linewidth]{/Users/jim.maloney/Book/images/ch6/BalanisHandbookFig12-44.png}
\caption[Connected vs.\ unconnected array element comparison]{Design experiment comparing two $8 \times 8$ arrays: (a) connected array element, (b) unconnected array element, (c) embedded element gain comparison for a central element.  The connected array element far outperforms the unconnected element \cite{BalanisHB12}.}
\label{fig:WBA3}
\end{center}
\end{figure}
...
\begin{figure}
\begin{center}
\includegraphics[angle=0,width=\linewidth]{/Users/jim.maloney/Book/images/ch6/BalanisHandbookFig12-45.png}
\caption[Connected element gain vs.\ array size]{The connected element from Figure~\ref{fig:WBA3} simulated in arrays of various sizes.  The low-frequency performance limit is approximately proportional to overall array size \cite{BalanisHB12}.}
\label{fig:WBA4}
\end{center}
\end{figure}
...
\begin{figure}
\begin{center}
\includegraphics[angle=0,width=\linewidth]{/Users/jim.maloney/Book/images/ch6/BalanisHandbookFig12-46.png}
\caption[Measured EERG for 10:1 bandwidth fragmented array]{Embedded element realized gain (EERG) for a central element of a $10 \times 17$ array with 3-cm square unit cells, demonstrating 10:1 bandwidth with excellent model-measurement agreement \cite{BalanisHB12}.}
\label{fig:WBA5}
\end{center}
\end{figure}
...
\begin{figure}
\begin{center}
\includegraphics[angle=0,scale=0.4]{/Users/jim.maloney/Book/images/ch6/BalanisHandbookFig12-47.png}
\caption[Half-wave ground plane null demonstration]{When a broadband radiating sheet is placed in front of a simple PEC ground plane, the resulting gain suffers nulls at frequencies where the separation distance is an integer multiple of $\lambda/2$ (in this case, 6~GHz for a 2.5-cm separation) \cite{BalanisHB12}.}
\label{fig:WBA6}
\end{center}
\end{figure}
...
\begin{figure}
\begin{center}
\includegraphics[angle=0,width=\linewidth]{/Users/jim.maloney/Book/images/ch6/BalanisHandbookFig12-48.png}
\caption[Half-wave null frequency vs.\ scan angle]{The half-wave null frequency depends on scan angle.  Left: geometry illustration.  Right: contour plot showing the relationship between field intensity at the radiating surface, frequency, and scan angle for a 2.5-cm separation \cite{BalanisHB12}.}
\label{fig:WBA7}
\end{center}
\end{figure}
...
\begin{figure}
\begin{center}
\includegraphics[angle=0,width=\linewidth]{/Users/jim.maloney/Book/images/ch6/BalanisHandbookFig12-49.png}
\caption[R-card layer eliminating half-wave null]{A $377~\Omega$/square r-card layer placed halfway between the radiating surface and the PEC ground plane (2.5-cm separation) eliminates the deep null at $\lambda/2$ \cite{BalanisHB12}.}
\label{fig:WBA8}
\end{center}
\end{figure}
...
\begin{figure}
\begin{center}
\includegraphics[angle=0,scale=0.4]{/Users/jim.maloney/Book/images/ch6/BalanisHandbookFig12-50.png}
\caption[Broadside gain with broadband screen backplane]{Normalized realized gain at broadside for the configuration of Figure~\ref{fig:WBA8}, showing that the deep null at 6~GHz has been improved to approximately 3~dB insertion loss \cite{BalanisHB12}.}
\label{fig:WBA9}
\end{center}
\end{figure}
...
\begin{figure}
\begin{center}
\includegraphics[angle=0,width=\linewidth]{/Users/jim.maloney/Book/images/ch6/BalanisHandbookFig12-51.png}
\caption[First 10:1 broadband screen backplane array]{The first array built using the broadband screen backplane: a 10:1 design with efficiency better than 50\% ($< 3$~dB insertion loss) from 1 to 10~GHz \cite{BalanisHB12}.}
\label{fig:WBA10}
\end{center}
\end{figure}
...
\begin{figure}
\begin{center}
\includegraphics[angle=0,width=\linewidth]{/Users/jim.maloney/Book/images/ch6/BalanisHandbookFig12-52.png}
\caption[Aperture fields with and without broadband screen]{Aperture fields 3 inches in front of a PEC surface, with and without a broadband screen backplane \cite{BalanisHB12}.}
\label{fig:WBA11}
\end{center}
\end{figure}
...
\begin{figure}
\begin{center}
\includegraphics[angle=0,width=\linewidth]{/Users/jim.maloney/Book/images/ch6/BalanisHandbookFig12-53.png}
\caption[Broadband screen performance vs.\ scan angle]{Contour plots comparing the configurations of Figure~\ref{fig:WBA11} over a range of scan angles.  The broadband screen effectively eliminates standing-wave nulls to scan angles beyond $60^\circ$ \cite{BalanisHB12}.}
\label{fig:WBA12}
\end{center}
\end{figure}
...
\begin{figure}
\begin{center}
\includegraphics[angle=0,width=\linewidth]{/Users/jim.maloney/Book/images/ch6/BalanisHandbookFig12-54.png}
\caption[Preferential forward radiation from thick aperture]{Thought experiment demonstrating the benefit of preferential forward radiation.  A radiator with finite thickness can achieve asymmetric radiation (front-to-back ratio), mitigating the impact of ground plane reflections \cite{BalanisHB12}.}
\label{fig:WBA13}
\end{center}
\end{figure}
...
\begin{figure}
\begin{center}
\includegraphics[angle=0,width=\linewidth]{/Users/jim.maloney/Book/images/ch6/BalanisHandbookFig12-55.png}
\caption[Two-layer radiator front-to-back ratio optimization]{Idealized design with two simultaneously optimized radiating layers and no ground plane.  The design goal was to maximize front-to-back ratio \cite{BalanisHB12}.}
\label{fig:WBA14}
\end{center}
\end{figure}
...
\begin{figure}
\begin{center}
\includegraphics[angle=0,scale=0.4]{/Users/jim.maloney/Book/images/ch6/BalanisHandbookFig12-56.png}
\caption[Parasitic layers with PEC backplane, 10:1 bandwidth]{Parasitic layers directing radiation forward in the presence of a PEC backplane, keeping insertion loss below 2~dB over most of a 10:1 bandwidth \cite{BalanisHB12}.}
\label{fig:WBA15}
\end{center}
\end{figure}
...
\begin{figure}
\begin{center}
\includegraphics[angle=0,width=\linewidth]{/Users/jim.maloney/Book/images/ch6/BalanisHandbookFig12-57.png}
\caption[Two- and three-face-sheet radiator experiments]{Design experiments with two and three radiating face sheets.  The ground plane has been replaced in each simulation with a perfectly absorbing back boundary.  Normalized gain levels above $-3$~dB indicate front-to-back ratio enhancement \cite{BalanisHB12}.}
\label{fig:WBA16}
\end{center}
\end{figure}
...
\begin{figure}
\begin{center}
\includegraphics[angle=0,width=\linewidth]{/Users/jim.maloney/Book/images/ch6/BalanisHandbookFig12-58.png}
\caption[Predicted 33:1 array performance in periodic simulation]{Predicted performance of the 33:1 antenna design in a periodic simulation, including realistic feed structures.  Antenna efficiency is better than 50\% over the entire 0.3--10~GHz bandwidth \cite{BalanisHB12}.}
\label{fig:WBA17}
\end{center}
\end{figure}
...
\begin{figure}
\begin{center}
\includegraphics[angle=0,width=\linewidth]{/Users/jim.maloney/Book/images/ch6/BalanisHandbookFig12-59.png}
\caption[Construction details of 33:1 test array]{Construction details of the 33:1 antenna design, including a photograph of the $23 \times 23$ element test piece used to measure embedded element realized gain \cite{BalanisHB12}.}
\label{fig:WBA18}
\end{center}
\end{figure}
...
\begin{figure}
\begin{center}
\includegraphics[angle=0,scale=0.4]{/Users/jim.maloney/Book/images/ch6/BalanisHandbookFig12-60.png}
\caption[Measured broadside EERG for 33:1 test antenna]{Compilation of measured EERG data at broadside for the 33:1 test antenna (three antenna ranges, two polarizations) compared with numerical predictions.  The dashed line represents the element area gain \cite{BalanisHB12}.}
\label{fig:WBA19}
\end{center}
\end{figure}
...
\begin{figure}
\begin{center}
\includegraphics[angle=0,width=\linewidth]{/Users/jim.maloney/Book/images/ch6/BalanisHandbookFig12-61.png}
\caption[Modeled vs.\ measured EERG pattern cuts]{Comparison of modeled (solid lines) and measured (data markers) EERG pattern cuts at several discrete frequencies, showing excellent agreement \cite{BalanisHB12}.}
\label{fig:WBA20}
\end{center}
\end{figure}
...
\begin{figure}
\begin{center}
\includegraphics[angle=0,width=\linewidth]{/Users/jim.maloney/Book/images/ch6/5996889-fig-2-hires.png}
\caption[Measured scan volume contours for 33:1 array]{Compilation of measured EERG angle cuts normalized to the maximum at each frequency.  The resulting contours indicate achievable scan volume.  No scan blindness is observed within the operating bandwidth \cite{PringleEtAl}.}
\label{fig:WBA21}
\end{center}
\end{figure}
...
\begin{figure}
\begin{center}
\includegraphics[angle=0,width=\linewidth]{/Users/jim.maloney/Book/images/ch6/5996889-fig-11-hires.png}
\caption[Array thickness scaling with lowest frequency]{Results of several design exercises for fragmented arrays.  For air-filled cavities, the antenna thickness is approximately $\lambda/12$ at the lowest operating frequency \cite{PringleEtAl}.}
\label{fig:WBA22}
\end{center}
\end{figure}

\section{Unbalanced Feed Arrays}

More recently, Landgren et al.\ at GTRI developed wideband phased arrays using a single unbalanced (single-ended) coaxial feed per element, eliminating the need for baluns or differential electronics \cite{Landgren2017Unbalanced}.  The unit cell consists of multiple layers of low-permittivity materials, a coaxial feed, and one or two fragmented aperture layers (a driven layer and an optional parasitic director layer) with no vias.  This all-planar construction significantly simplifies manufacturing compared to the machined aluminum feed tower approach described earlier.

A 4$\times$4 prototype array was fabricated and measured to validate the design.  Figure~\ref{fig:WBA23} shows the assembled array with an inset of a single unit cell, the measured broadside realized gain compared with simulation, and the simulated effect of array size on normalized gain.  The measured gain of the 4$\times$4 array agrees closely with the FDTD prediction across the $L$-, $S$-, and $C$-bands ($\sim\!1.4$--6.7~GHz), confirming that the unbalanced feed approach delivers ultra-wideband performance without baluns.  The array size study shows that for arrays larger than 8$\times$8 elements, the realized gain is within 1.5~dB of the infinite array prediction.

\begin{figure}
\begin{center}
\includegraphics[angle=0,width=0.95\linewidth]{/Users/jim.maloney/Book/images/ch6/landgren/Landgren2017ITC_Fig5_cropped.png}
\caption[Unbalanced-feed wideband prototype array results]{Unbalanced-feed 4$\times$4 prototype array: (a) assembled array with unit cell inset, (b) measured vs.\ simulated broadside realized gain, and (c) normalized gain for varying array sizes compared to infinite array prediction \cite{Landgren2017Unbalanced}.}
\label{fig:WBA23}
\end{center}
\end{figure}

This prototype array was subsequently scaled to a full 16$\times$16 element array with integrated fragmented power combiners for deployment at the U.S.\ Army Aberdeen Test Center; the combiner technology is described in Chapter~10.

\section{Competing Approaches: Tightly Coupled Dipole Arrays}

The fragmented aperture approach is not the only path to ultra-wideband phased arrays.  Tightly coupled dipole arrays (TCDAs) achieve wide bandwidth through strong inter-element coupling between closely spaced dipoles, an approach with roots in Wheeler's current sheet concept and Munk's complementary antenna theory.  Doane, Sertel, and Volakis \cite{Doane2013TCDAIB} demonstrated a TCDA with an integrated Marchand balun achieving 7.35:1 bandwidth (0.68--5.0~GHz) with scanning to $\pm 45^{\circ}$---bandwidth competitive with fragmented aperture arrays.  More recently, Dang, Yong, and Glazunov \cite{Dang2025LowProfile} presented a low-profile TCDA with a metasurface superstrate operating from 12--30~GHz with $\pm 60^{\circ}$ scanning, targeting Ku/K/Ka-band SATCOM and 6G applications.  Hosseini and Atlasbaf \cite{Hosseini2023TCDA} developed a semi-analytical transmission-line model for TCDAs with metasurface superstrates that runs approximately $7\times$ faster than full-wave simulation, highlighting one advantage of the TCDA approach: its canonical dipole geometry is analytically tractable, enabling rapid design-space exploration that the fragmented aperture approach, which relies on full-wave optimization, cannot match.  However, TCDAs require balanced feeds (baluns) that add complexity, and their achievable bandwidth is determined largely by element geometry and feed design rather than by algorithmic optimization of the conducting pattern.  The fragmented aperture approach trades analytical tractability for design flexibility: by optimizing fragment-by-fragment, it can exploit mutual coupling in ways that a prescribed dipole geometry cannot.
