...
\caption{Wide-scan fragmented array element without superstrate: (a)~reflection coefficient at broadside and E/H-plane scan to $45^{\circ}$ and $60^{\circ}$; (b)~$20 \times 20$ pixel unit cell geometry ($d_1 = 10$~mm, $\epsilon_{r1} = 2.2$, $Z_c = 171~\Omega$).  The element achieves VSWR~$\leq 2$ over 1.94:1 bandwidth for $45^{\circ}$ scan \cite{Ellgardt2006Wide}.}
...
\caption{Wide-scan fragmented array element with superstrate: (a)~reflection coefficient at multiple scan angles; (b)~unit cell geometry ($d_1 = 8.67$~mm, $\epsilon_{r1} = 3.00$, $d_2 = 8$~mm, $\epsilon_{r2} = 3.38$, $Z_c = 173~\Omega$).  The superstrate improves scan bandwidth to 2.20:1 for $45^{\circ}$ scan \cite{Ellgardt2006Wide}.}
