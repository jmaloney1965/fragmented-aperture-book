...
\includegraphics[angle=0,width=\linewidth]{/Users/jim.maloney/Book/images/appendixA/AntChapOrigFig1.png}
\caption[FDTD computational volume, lattice, and unit cell]{Schematic drawing showing the computational volume, FDTD spatial lattice, and unit cell.}
\label{fig:ACF1}
...
\begin{figure}
\includegraphics[angle=0,width=\linewidth]{/Users/jim.maloney/Book/images/appendixA/AntChapOrigFig3.png}
\caption[FDTD transmitting antenna analysis schematic]{(a) Schematic drawing showing the basic elements involved in the FDTD analysis of a transmitting antenna. (b) Details for the near-field to far-field transformation.}
\label{fig:ACF3}
\end{figure}

\begin{figure}
\includegraphics[angle=0,width=\linewidth]{/Users/jim.maloney/Book/images/appendixA/AntChapOrigFig4.png}
\caption[Feed region details for transmitting and receiving]{The details for the feed region of (a) the transmitting antenna and (b) the receiving antenna. The characteristic impedance of the transmission line is $R_o$, and the source and termination are matched to this impedance.}
\label{fig:ACF4}
\end{figure}
...
\begin{figure}
\includegraphics[angle=0,width=\linewidth]{/Users/jim.maloney/Book/images/appendixA/AntChapOrigFig5.png}
\caption[FDTD receiving antenna analysis schematic]{(a) Schematic drawing showing the basic elements involved in the FDTD analysis of a receiving antenna. (b) Details for the plane-wave source.}
\label{fig:ACF5}
\end{figure}
...
\begin{table}
\caption[Input signal characteristics]{Characteristics for Various Input Signals.}
\label{tab:ACT1}
...
\begin{figure}
\includegraphics[angle=0,width=\linewidth]{/Users/jim.maloney/Book/images/appendixA/AntChapOrigFig7.png}
\caption[Cylindrical monopole antenna and FDTD model]{(a) Cylindrical monopole antenna fed through an image plane from a coaxial transmission line. (b) FDTD model for the cylindrical monopole antenna. The PML that surrounds the computational space is not shown.}
\label{fig:ACF7}
\end{figure}
...
\begin{figure}
\includegraphics[angle=0,width=\linewidth]{/Users/jim.maloney/Book/images/appendixA/AntChapOrigFig8.png}
\caption[Monopole antenna: theory vs.\ measurement]{Comparison of theoretical and measured results for the cylindrical monopole antenna. (a) Reflected voltage in the coaxial line. (b) Electric field on the image plane at $\rho/h = 12.7$.}
\label{fig:ACF8}
\end{figure}
...
\begin{table}
\caption[FDTD discretization for cylindrical monopole]{FDTD Discretization Parameters for the Cylindrical Monopole Antenna.}
\label{tab:ACT2}
...
\begin{figure}
\begin{center}
\includegraphics[angle=0,scale=0.5]{/Users/jim.maloney/Book/images/appendixA/AntChapOrigFig10.png}
\end{center}
\caption[Monopole input admittance convergence study]{Comparison of theoretical and measured results for the input admittance of the cylindrical monopole antenna. Results are shown for three levels of discretization (A, B, C) in the FDTD method. (After Hertel and Smith \cite{Smith2003}, \copyright~2003 IEEE.)}
\label{fig:ACF10}
\end{figure}
...
\begin{figure}
\includegraphics[angle=0,width=\linewidth]{/Users/jim.maloney/Book/images/appendixA/AntChapOrigFig11.png}
\caption[Simplified FDTD monopole models]{Simplified models for the cylindrical monopole antenna. (a) Model incorporating a ``hard source.'' (b) Model incorporating a virtual one-dimensional transmission line. The monopole conductor has a square cross section in both models.}
\label{fig:ACF11}
\end{figure}
...
\begin{figure}
\begin{center}
\includegraphics[angle=0,scale=0.5]{/Users/jim.maloney/Book/images/appendixA/AntChapOrigFig12.png}
\end{center}
\caption[Simplified model admittance comparison]{Comparison of theoretical and measured results for the input admittance of the cylindrical monopole antenna. Results are shown for the two simplified FDTD models. (After Hertel and Smith \cite{Smith2003}, \copyright~2003 IEEE.)}
\label{fig:ACF12}
\end{figure}
...
\begin{figure}
\begin{center}
\includegraphics[angle=0,scale=0.8]{/Users/jim.maloney/Book/images/appendixA/AntChapOrigFig13.png}
\end{center}
\caption[Stair-stepped PEC approximation on FDTD lattice]{(a) Rectangular FDTD lattice superimposed on the cross section of an object that is a perfect electric conductor (PEC). (b) The surface of the object has been deformed to conform to the rectangular lattice; the surface of the object has been replaced by a stair-stepped approximation.}
\label{fig:ACF13}
\end{figure}
...
\begin{figure}
\includegraphics[angle=0,width=\linewidth]{/Users/jim.maloney/Book/images/appendixA/AntChapOrigFig14.png}
\caption[Pyramidal horn antenna FDTD model geometry]{Schematic drawing for the pyramidal horn antenna. The inset shows the FDTD cells used to model the bottom of the horn.}
\label{fig:ACF14}
\end{figure}
...
\begin{figure}
\includegraphics[angle=0,width=\linewidth]{/Users/jim.maloney/Book/images/appendixA/AntChapOrigFig15.png}
\caption[Horn antenna patterns and gain vs.\ frequency]{Comparison of theoretical and measured results for the pyramidal horn antenna. (a) E-plane pattern and (b) H-plane pattern at 10~GHz. (c) Boresight gain versus frequency.}
\label{fig:ACF15}
\end{figure}
...
\begin{figure}\begin{center}
\includegraphics[angle=0,width=\linewidth]{/Users/jim.maloney/Book/images/appendixA/AntChapOrigFig16.png}
\caption[Electric field snapshots in transmitting horn]{Gray-scale plots for the magnitude of the electric field on the vertical symmetry plane of the transmitting horn antenna. The excitation is a sinusoid amplitude modulated by a Gaussian pulse.}
\label{fig:ACF16}
\end{center}\end{figure}
...
\begin{figure}\begin{center}
\includegraphics[angle=0,width=\linewidth]{/Users/jim.maloney/Book/images/appendixA/AntChapOrigFig17.png}
\caption[Two-arm conical spiral antenna geometry]{Geometry for the two-arm conical spiral antenna. (After Hertel and Smith \cite{Hertel02}, \copyright~2002 IEEE.)}
\label{fig:ACF17}
\end{center}\end{figure}
...
\begin{figure}\begin{center}
\includegraphics[angle=0,scale=0.75]{/Users/jim.maloney/Book/images/appendixA/AntChapOrigFig18.png}
\caption[FDTD cell arrangement for conical spiral model]{Schematic drawing showing the arrangement of FDTD cells used to model the conical spiral antenna. For clarity, only the lower 10\% of the antenna is shown. (After Hertel and Smith \cite{Hertel02}, \copyright~2002 IEEE.)}
\label{fig:ACF18}
\end{center}\end{figure}
...
\begin{figure}\begin{center}
\includegraphics[angle=0,scale=0.8]{/Users/jim.maloney/Book/images/appendixA/AntChapOrigFig19.png}
\caption[Conical spiral reflection coefficient and gain]{Comparison of theoretical and measured results for the conical spiral antenna. (a) Magnitude of reflection coefficient versus frequency. (b) Realized gain in the boresight direction versus frequency. (After Hertel and Smith \cite{Hertel02}, \copyright~2002 IEEE.)}
\label{fig:ACF19}
\end{center}\end{figure}
...
\begin{figure}\begin{center}
\includegraphics[angle=0,width=\linewidth]{/Users/jim.maloney/Book/images/appendixA/AntChapOrigFig20.png}
\caption[Electric field snapshots near conical spiral]{Gray-scale plots for the magnitude of the electric field near the conical spiral antenna for three instants in time: (a) $t/\tau_L=0.1$, (b) $t/\tau_L=0.6$, and (c) $t/\tau_L=1.1$, where $\tau_L$ is the time for light to travel the length of the spiral arm. (After Hertel and Smith \cite{Hertel03}, \copyright~2003 IEEE.)}
\label{fig:ACF20}
\end{center}\end{figure}
...
\begin{figure}\begin{center}
\includegraphics[angle=0,width=\linewidth]{/Users/jim.maloney/Book/images/appendixA/AntChapOrigFig21.png}
\caption[TEM horn geometry and stair-step approximations]{(a) Schematic drawing for the TEM horn antenna (monopole configuration). (b) Cross sections showing the stair-stepped approximation to the plate for two different cases, A and B.}
\label{fig:ACF21}
\end{center}\end{figure}
...
\begin{figure}\begin{center}
\includegraphics[angle=0,scale=0.7]{/Users/jim.maloney/Book/images/appendixA/AntChapOrigFig22.png}
\caption[TEM horn stair-step approximation comparison]{Results for two different stair-stepped approximations (A and B) applied to the TEM horn antenna. (a) The reflected voltage in the feeding transmission line; the reflection from the open end of the horn has been windowed out. (b) The magnitude of the Fourier transform of the reflection coefficient for the antenna.}
\label{fig:ACF22}
\end{center}\end{figure}
...
\begin{figure}\begin{center}
\includegraphics[angle=0,scale=0.7]{/Users/jim.maloney/Book/images/appendixA/AntChapOrigFig23.png}
\caption[Coaxial-fed rectangular microstrip patch geometry]{Rectangular microstrip patch antenna fed by a coaxial line probe.}
\label{fig:ACF23}
\end{center}\end{figure}
...
\begin{figure}\begin{center}
\includegraphics[angle=0,scale=0.7]{/Users/jim.maloney/Book/images/appendixA/AntChapOrigFig24.png}
\caption[Reflected voltage for microstrip patch antennas]{The magnitude of the reflected voltage in the feeding coaxial line versus the normalized time. (a) Rectangular microstrip patch. (b) Narrow-band, rectangular microstrip patch.}
\label{fig:ACF24}
\end{center}\end{figure}
...
\begin{figure}\begin{center}
\includegraphics[angle=0,scale=0.7]{/Users/jim.maloney/Book/images/appendixA/AntChapOrigFig25.png}
\caption[Microstrip patch reflection coefficient and patterns]{Comparison of theoretical and measured results for the rectangular microstrip patch antenna. (a) Magnitude of reflection coefficient versus frequency. (b) Field patterns for E and H planes at the frequency $f = 6.8$~GHz. Measured results from \cite{Change}.}
\label{fig:ACF25}
\end{center}\end{figure}
...
\begin{figure}\begin{center}
\includegraphics[angle=0,scale=1.0]{/Users/jim.maloney/Book/images/appendixA/AntChapOrigFig26.png}
\caption[Narrow-band patch convergence with time steps]{Narrow-band, rectangular microstrip patch antenna. Magnitude of reflection coefficient versus frequency for three different numbers of time steps.}
\label{fig:ACF26}
\end{center}\end{figure}

\section{FDTD Analysis of Periodic Structures}
\label{sec:FDTD_PBC}

Many structures of electromagnetic interest possess a periodicity in one or more dimensions.  For example, a frequency selective surface (FSS) is commonly used in a radome to control the energy that reaches an antenna.  A typical FSS consists of one or more layers of material, each formed from an element periodically replicated in two dimensions.  Another periodic structure that has received considerable attention in recent years is the photonic bandgap (PBG) or electronic bandgap (EBG) structure---a type of periodic dielectric structure that has frequency regions in which electromagnetic propagation is forbidden.  A third type of structure that can be considered periodic is an antenna array.  If large enough, many of the important parameters of an array can be analyzed by assuming that the structure is infinitely periodic.  The fragmented aperture array antennas described in this book are designed using precisely this approach.

\subsection{The Unit Cell and Periodic Boundary Conditions}

The FDTD technique can be applied to the analysis of periodic structures by modeling only a single \emph{unit cell} and using boundary conditions to simulate the effect of periodic replication.  This dramatically reduces the computational burden compared to modeling an entire array or surface.

As an example, consider a two-dimensional electromagnetic screen consisting of infinitely long, periodic conducting bars of width $w$, thickness $d$, and separation gap $g$.  The illumination is an electromagnetic plane wave with the electric field parallel to the bars (TE polarization) and direction of propagation at angle $\phi_i$ with respect to the $x$~axis.  Because of the periodicity inherent in the geometry, only the fields in the unit cell are unique and need to be determined.

Now consider discretizing the solution space within the unit cell using a lattice of traditional Yee cells \cite{Yee66}.  Field components that can be updated using fields entirely within the unit cell are straightforward.  However, field components at the edges of the unit cell require values from outside the cell.  These ``missing'' values are supplied by periodic boundary conditions (PBCs) that relate the fields on one side of the unit cell to those on the other side.  The relationship depends on the angle at which the incident field impinges on the structure.  In the frequency domain, the relationship is:
\begin{align}
\begin{split}
H_x(x, y_p + \Delta y/2, \omega) &= H_x(x, \Delta y/2, \omega) \exp(-j k_y y_p), \\
E_z(x, 0, \omega) &= E_z(x, y_p, \omega) \exp(+j k_y y_p),
\label{eqn:PBC_freq}
\end{split}
\end{align}
where $k_y = k_o \sin(\phi_i)$, $k_o = \omega/c$ is the free-space wavenumber, and $c$ is the free-space speed of light.  Since FDTD operates in the time domain, the boundary conditions must be expressed accordingly.  In the time domain, (\ref{eqn:PBC_freq}) becomes
\begin{align}
\begin{split}
H_x(x, y_p + \Delta y/2, t) &= H_x(x, \Delta y/2, t - y_p \sin\phi_i / c), \\
E_z(x, 0, t) &= E_z(x, y_p, t + y_p \sin\phi_i / c).
\label{eqn:PBC_time}
\end{split}
\end{align}
...
Equation~(\ref{eqn:PBC_time}) reveals a fundamental difficulty: the periodic boundary condition requires both previous \emph{and future} field values.  Specifically, the $H_x$ values at $y = y_p + \Delta y/2$ are equal to \emph{previous} values of $H_x$ at $y = \Delta y/2$---these can simply be stored.  However, the $E_z$ values at $y = 0$ are equal to \emph{future} values of $E_z$ at $y = y_p$, and there is no simple way to obtain field values that have not yet been computed.

This causality problem has been addressed by a variety of techniques, which can be broadly divided into two classes: those that avoid the problem by reformulating the equations (e.g., the sine/cosine method, split-field method, and spectral-domain method) and those that solve the problem directly (e.g., time-shift interpolation and multiple-angle methods).  A comprehensive discussion of all these techniques can be found in \cite{MaloneyKeslerPBC}.

\subsection{Spectral-Domain FDTD}
\label{sec:spectral_FDTD}

One particularly useful approach for antenna array design is the spectral-domain FDTD method \cite{Aminian}.  In the spectral-domain formulation, the FDTD simulation is performed at a fixed transverse wavenumber $(k_x, k_y)$ rather than at a fixed scan angle $(\theta, \phi)$.  The PBC is still implemented as a wrap-around boundary, but the constant transverse wavenumber means that the effective scan angle is frequency dependent.

This has an important practical consequence: a single broadband FDTD simulation at a given transverse wavenumber sweeps through different scan angles as it sweeps through frequency.  By running a small number of such simulations at different transverse wavenumbers, the full scan-volume performance of an array element can be characterized over a wide bandwidth with modest computational cost.  This technique is central to the wide-scan fragmented aperture array design methodology described in Chapter~7.
...
\begin{figure}\begin{center}
\includegraphics[angle=0,scale=1.0]{/Users/jim.maloney/Book/images/appendixA/AntChapOrigFig27.png}
\caption[FDTD publication growth over twenty years]{Number of documents published over a twenty-year span that include the words ``finite-difference time-domain'' or ``FDTD'' in the title. Each bar shows the total number of documents published during a five-year period.}
\label{fig:ACF27}
\end{center}\end{figure}
...
\bibitem{MaloneyKeslerPBC} J. G. Maloney and M. P. Kesler, ``Analysis of Periodic Structures,'' Chapter 6 in A. Taflove, Editor, Advances in Computational Electrodynamics, The Finite-Difference Time-Domain Method, pp. 345--407, Artech House, Boston, 1998. Also, J. G. Maloney and M. P. Kesler, ``Analysis of Periodic Structures,'' Chapter 13 in A. Taflove and S. Hagness, Editors, Computational Electrodynamics: The Finite-Difference Time-Domain Method, 3rd Edition, Artech House, Boston, 2005.

\bibitem{Aminian} A. Aminian and Y. Rahmat-Samii, ``Spectral FDTD: A Novel Technique for the Analysis of Oblique Incident Plane Wave on Periodic Structures,'' IEEE Trans. Antennas Propagat., Vol. 54, pp. 1818--1825, June 2006.
